...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LeaveListUserControl.ascx.cs" Inherits="DeptNews.LeaveList.LeaveListUserControl" %>
...
<div style="padding:5px;">
    <div id="wbtitle" runat="server"><h3>待审请假</h3></div>
...
<!--打印-->
<asp:Button ID="btnPrint" runat="server" Text="查看请假审批表" OnClick="btnPrint_Click" />
<div id="printDiv" runat="server"  style='text-align:center;padding:5px;'>
  
</div>
<div id="dayinjiaoben" runat="server" visible="false">
    <input name="a_print" type="button" class="ipt" onClick="printdiv('sty');" value="打 印">
    <script type="text/javascript">
