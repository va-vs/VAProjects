...
//控制首页等功能的显示与不显示
function firstLink() { firstSpan.innerHTML = "<a href='javascript:firstPage();'> << </a>"; }

function firstText() { firstSpan.innerHTML = " << "; }

function preLink() { preSpan.innerHTML = "<a href='javascript:prePage();'> < </a>"; }

function preText() { preSpan.innerHTML = " < "; }

function nextLink() { nextSpan.innerHTML = "<a href='javascript:nextPage();'> > </a>"; }

function nextText() { nextSpan.innerHTML = " > "; }

function lastLink() { lastSpan.innerHTML = "<a href='javascript:lastPage();'> >> </a>"; }

function lastText() { lastSpan.innerHTML = " >> "; }