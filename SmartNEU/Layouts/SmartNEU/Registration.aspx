...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="SmartNEU.Layouts.SmartNEU.Registration" DynamicMasterPageFile="~masterurl/default.master" %>
...
<div id="divregInfo" runat="server">
    <table style=" font-size:14px; color:#494b4c" cellspacing="0" cellpadding="3">
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtAccount" runat="server" CssClass="txtcss" onfocus="onftxtAccount()" onblur="onbtxtAccount()" ToolTip="必填项！注册账户必须填写本人的工号或学号" AutoPostBack="True"></asp:TextBox>(工号或学号) <br/><span  style="font-size:14px; color:red;  margin-left:10px" id="spanAcc"></span><div id="divAccountMsg"  style=" color :red "   runat="server"  ></div></td>

        </tr>
        <tr>
            <td class="tdone">密 码：<span style="color:red">*</span></td>
            <td>
                <asp:TextBox ID="txtPwd" runat="server" TextMode="Password" CssClass="txtcss" onfocus="onfocusjs()" onblur="onblurjs()" ToolTip="必填项！密码最少6位" CausesValidation="True" AutoPostBack="True"></asp:TextBox><span  style="font-size:14px; color:red;  margin-left:10px" id="spanPwd"></span><br/>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:TextBox ID="txtPwd1" runat="server" TextMode="Password" CssClass="txtcss" onfocus="onft(this)" onblur="onblurjs()" ToolTip="必填项！两次密码必须一致" CausesValidation="True" AutoPostBack="True"></asp:TextBox><span  style="font-size:14px; color:red;  margin-left:10px" id="spanPwd1"></span><br/>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtName" runat="server" CssClass="txtcss" onfocus="onft(this)" onblur="onbtName()" ToolTip="必填项！姓名只能输入中文" AutoPostBack="True"></asp:TextBox><span  style="font-size:14px; color:red;  margin-left:10px" id="spanName"></span><br/>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtTelephone" runat="server" CssClass="txtcss" onfocus="onft(this)" onblur="onbtTel()" ToolTip="选填！电话格式必须正确，比如：18888888888" AutoPostBack="True"></asp:TextBox><span  style="font-size:14px; color:red;  margin-left:10px" id="spanTel"></span><br/>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtEmail" runat="server" CssClass="txtcss" onfocus="onft(this)" onblur="onbtEmail()" ToolTip="必填项！邮箱格式必须正确，比如：example@mail.com" AutoPostBack="True"></asp:TextBox><span  style="font-size:14px; color:red;  margin-left:10px" id="spanEmail"></span><br/>
     ...
     <div id="divregSuccess" runat="server" visible="false">
            <table cellpadding="0" align="center" class="stable">
                <tbody>
                    <tr>
                        <th valign="middle">
                            <font face="微软雅黑" size="5" style="color: rgb(255, 255, 255); ">智慧东大：Smart Learning，Smart Work，Smart Life</font>
                        </th>
                    </tr>
                    <tr>
                        <td>
                            <div style="padding:25px 35px 40px; background-color:#fff;">
                                ...
                                <div style="line-height:25px;">首先感谢您加入智慧东大！<br/> 您的登录账号是<asp:Label ID="lbuseAcc" runat="server" Text=""></asp:Label>，请在登录页面中输入“<asp:Label ID="lbuserADAcc" runat="server" Text=""></asp:Label>”账号格式和密码登录。
                                    <br/>您的注册信息已发送到您预留的邮箱中，请注意查收！
                                    <br/> 请您在发表内容时，遵守当地法律法规及<a href="http://va.neu.edu.cn/SmartNEU/Pages/Rules.aspx" class="f_blue">本站相关规定</a>。
                                    <br/> <br/>
                                    <div style="text-align:center;">
                                        <a href="http://va.neu.edu.cn/SmartNEU/_layouts/15/Authenticate.aspx?Source=%2FSmartNEU" style="font-size:16px;color:#C46200" class="f_blue">点此马上登录</a>&nbsp;&nbsp;
                                        <a href="http://va.neu.edu.cn/SmartNEU/" class="f_blue" style="font-size:16px;color:royalblue">返回网站首页</a>
                                    </div>
                                    <br/><br/>
                                    <br/>如果您有什么疑问可以联系管理员，Email: <a href="mailto:smartneu@mail.neu.edu.cn" class="f_blue">smartneu@mail.neu.edu.cn</a>
                                    <br/>

                                </div>
                                <p align="right">SmartNEU - 智慧东大</p>
                                <p align="right">
