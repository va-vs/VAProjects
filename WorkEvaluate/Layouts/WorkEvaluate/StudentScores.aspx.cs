...
{
    public partial class StudentScores : LayoutsPageBase
    {
        #region 属性
        ...
        /// 当前期次的待评作品
        /// </summary>
        private DataSet GetWorksToEvaluate
        {
            get
            {
                if (ViewState["WorksAll"] == null)
                {
                    ...
                    DataSet dsSearch = DAL.Works.GetWorksToEvaluate(DAL.Common.LoginID,PeriodID,0 );
        ...
        {
            DataSet dsSearch = GetWorksToEvaluate;
