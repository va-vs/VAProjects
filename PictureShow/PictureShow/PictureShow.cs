...
namespace PictureShow.PictureShow
{
    [ToolboxItemAttribute(false)]
    public class PictureShow : WebPart
    {
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            try
            {
                ...
                foreach (SPListItem item in list.Items)
                {
                    ...
                    eimg = eimg + site.Url+ img1[0].ToString() + "|";
                ...
                string txt = GetHtmlText(eimg, url1);
                writer.Write(txt);
            }
            catch (Exception e)
            { writer.Write(e.ToString()); }
        }
        private string GetHtmlText(string eimg, string url)
        {
            string _jsPath = "_layouts/15/PictureShow/";
            ...
            {
                sb.AppendLine("<li><a target=\"_blank\" href=\"" + linkUrls[i] + "\"><img src=\"" + imgUrls[i] + "\"></a></li>");
            }
